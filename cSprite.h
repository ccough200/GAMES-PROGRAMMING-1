...
public:
	...
	cSprite(D3DXVECTOR3 sPosition, D3DXVECTOR2 translation, LPDIRECT3DDEVICE9 pd3dDevice, LPCSTR theFilename); // Constructor
	~cSprite();			// Destructor
	...
	void update(float deltaTime);	// update the sprite position based on the translation
